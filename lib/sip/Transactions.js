...
const debugnict = require('util').debuglog('JsSIP:NonInviteClientTransaction');
const debugict = require('util').debuglog('JsSIP:InviteClientTransaction');
const debugact = require('util').debuglog('JsSIP:AckClientTransaction');
const debugnist = require('util').debuglog('JsSIP:NonInviteServerTransaction');
const debugist = require('util').debuglog('JsSIP:InviteServerTransaction');

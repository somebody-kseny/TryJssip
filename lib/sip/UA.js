...
const debug = require('util').debuglog('JsSIP:UA');
const debugerror = require('util').debuglog('JsSIP:ERROR:UA');
...
module.exports = class UA extends EventEmitter
{
  ...
  _loadConfig(configuration)
  {
    ...
    {
      this._configuration.contact_uri = new URI('sip', Utils.createRandomToken(8), this._configuration.via_host, null, { transport:  this._transport.scheme });
    }
